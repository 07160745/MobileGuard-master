...
public class AppLockService extends Service {
    ...
    class AppLockReceiver extends BroadcastReceiver{
        ...
        public void onReceive(Context context, Intent intent) {
            if (App.APP_OPS_SERVICE.equals(intent.getAction())){
            ...
            public void onChange(boolean selfChange) {
               ...
               dao=new AppLockDao(this);
                  ...
                  observer=new MyObserver(new Handler());
                   ...
                   IntentFilter filter=new IntentFilter(App.APP_OPS_SERVICE);
                       ...
                       while(flag){
                           if (Build.VERSION.SDK_INT>= Build.VERSION_CODES.LOLLIPOP){
                               ...
                               if (m!=null){
                                   ...
                                   List<UsageStats> stats=m.queryUsageStats(UsageStatsManager.INTERVAL_BEST,now,now);
                                   String topActiviy="";
