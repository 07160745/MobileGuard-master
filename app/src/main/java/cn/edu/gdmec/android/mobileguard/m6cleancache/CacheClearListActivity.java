...
public class CacheClearListActivity extends AppCompatActivity implements View.OnClickListener {
   ...
   private AnimationDrawable animation;
        ...
        public void handleMessage(Message msg){
            switch (msg.what){
                case SCANNING:
                    ...
                    mRecomandTV.setText("扫描"+info.packageName);
                    mCanCleanTV.setText("已经缓存"+ Formatter.formatFileSize(CacheClearListActivity.this,cacheMemory));
                    mCacheInfos.clear();
                ...
                case FINISH:
                    ...
                    if (cacheMemory>0) {
                        ...
                        Toast.makeText(CacheClearListActivity.this,"洁净如新",Toast.LENGTH_LONG).show();
                    }
                    break;
            }
        }
    ...
    public void getCacheSize(PackageInfo info) {
        try {
            Method method=PackageManager.class.getDeclaredMethod("getPackageSizeInfo", String.class,IPackageDataObserver.class);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
